...
Partial Public Class loginDataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByregno(ByVal regno As Integer) As Table1Row
            Return CType(Me.Rows.Find(New Object() {regno}),Table1Row)
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnregno.AutoIncrement = true
            Me.columnregno.AutoIncrementSeed = -1
            Me.columnregno.AutoIncrementStep = -1
    ...
    Partial Public Class Table1Row
        ...
        Public Property regno() As Integer
            Get
                Return CType(Me(Me.tableTable1.regnoColumn),Integer)
            End Get
            Set
                Me(Me.tableTable1.regnoColumn) = value
            End Set
        End Property
...
Namespace loginDataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`regno` = ?) AND ((? = 1 AND `username` IS NULL) OR "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `username` = ?, `password` = ? WHERE ((`regno` = ?) AND ((? ="& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.login.My.MySettings.Default.loginConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT regno, username, [password] FROM Table1"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_regno As Integer, ByVal Original_username As String, ByVal Original_password As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_regno,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal username As String, ByVal password As String, ByVal Original_regno As Integer, ByVal Original_username As String, ByVal Original_password As String) As Integer
            If (username Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Original_regno,Integer)
            If (Original_username Is Nothing) Then
